...
/**
 * 短暂的存储池。
 * RocketMQ单独创建一个MappedByteBuffer内存缓存池，
 * 用来临时存储数据，数据先写人该内存映射中，
 * 然后由commit 线程定时将数据从该内存复制到与目的物理文件对应的内存映射中。
 * RokcetMQ 引人该机制主要的原因是仅供提供一种内存锁定，
...
public class TransientStorePool {
    ...
    /**
     * **创建poolSize 个堆外内存，
     * 并利用com.sun.jna.Library 类库将该批内存锁定，
     * 避免被置换到交换区，提高存储性能。
     */
    public void init() {
